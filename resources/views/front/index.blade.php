...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section" class="max-w-[1200px] mx-auto w-full flex flex-col gap-10 pb-[50px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden">
        <nav class="flex justify-between items-center py-6 px-[50px]">
            <a href="{{route('front.index')}}" class="flex items-center gap-2">
                 <span class="text-white font-bold text-2xl">Nayaguna</span>
            </a>
        ...
        <div class="flex flex-col items-center gap-[30px]">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">Nayaguna provides high quality online courses for you to grow <br>
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        <div class="grid grid-cols-4 gap-[30px]">
            <a href="{{route('front.category', 'marketing-unpi')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Marketing Unpi</p>
            </a>
            <a href="{{route('front.category', 'software-enginering')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Software Enginering</p>
            </a>
            <a href="{{route('front.category', 'bisnis')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-2.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Bisnis</p>
            </a>
            <a href="{{route('front.category', 'joki-ml')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-3.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Joki ML</p>
            </a>
        </div>
        <div class="grid grid-cols-3 gap-[30px]">
            <a href="{{route('front.category', 'data-analis')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Data Analytics</p>
            </a>
            <a href="{{route('front.category', 'managemen-fisika')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-4.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Managemen <br> Fisika</p>
            </a>
            <a href="{{route('front.category', 'asuransi-kosan')}}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Asuransi Kosan</p>
            </a>
        </div>
    </section>
            ...
            <div class="group/slider flex flex-nowrap w-max items-center">
                <div class="testi-container animate-[slideToL_50s_linear_infinite] group-hover/slider:pause-animate flex gap-6 pl-6 items-center flex-nowrap">
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Nayaguna has helped me to grow from zero to perfect career, thank you!</p>
    ...
    <footer class="max-w-[1200px] mx-auto flex flex-col pt-[70px] pb-[50px] px-[100px] gap-[50px] bg-[#F5F8FA] rounded-[32px]">
        <div class="flex justify-between">
            <a href="">
                <div>
                    <span class="text-black font-bold text-2xl">Nayaguna</span>
                </div>
            </a>
        ...
        <div class="w-full h-[51px] flex items-end border-t border-[#E7EEF2]">
            <p class="mx-auto text-sm text-[#6D7786] -tracking-[2%]">All Rights Reserved Nayaguna BuildWithAngga 2024</p>
        </div>
    </footer>
