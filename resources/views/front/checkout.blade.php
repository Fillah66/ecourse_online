            ...
            <form action="{{route('front.checkout.store')}}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5">
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Ibu Eva</p>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Nayaguna</p>
                ...
                <div class="relative">
                    <select name="course_id" id="course_id" class="p-4 rounded-full flex gap-3 w-full ring-1 ring-black transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">
